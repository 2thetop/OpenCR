...
public:
    ...
    void setupUi(QDialog *Dialog)
    {
        ...
        widget->setGeometry(QRect(10, 450, 821, 220));
        ...
        progressBar_Status = new QProgressBar(widget);
        ...
        widget1->setGeometry(QRect(180, 12, 191, 411));
        ...
        led_SerialOnOff = new HLed(widget1);
        ...
        led_MavlinkStatus = new HLed(widget1);
